var objects = [];
   ...
   function createPoint(name, position, description, url) {
    ...
    createPoint('Fontanna Neptuna',[54.348536,18.653224],"images/neptun.jpg", "Stojąca od 1633 r. przed Dworem Artusa Fontanna Neptuna jest symbolem Gdańska. Inicjatorem jej powstania był burmistrz Gdańska Bartłomiej Schachmann. Postać Neptuna nawiązuje do związków Gdańska z morzem. Wymodelowali ją Peter Husen i Johann Rogge, a odlana została w 1615 roku w Augsburgu. Autorem projektu całej fontanny był Abraham van den Blocke.");

    createPoint('Złota Kamienica',[54.348573,18.653787],"images/zlotakamienica.jpg", "Jest jednym z najpiękniejszych budynków gdańskich. Została wzniesiona dla burmistrza Jana Speymanna, bogatego kupca i światłego mecenasa sztuk oraz jego żony Judyty z Bahrów. Powstała przed 1609 r., według projektu Abrahama van den Blocke, który był także autorem części wystroju rzeźbiarskiego, ukończonego do 1618 r.");

    createPoint('Dom Uphagena',[54.349400,18.649375],"images/domuphagena.jpg", "Dom Uphagena stoi przy ul. Długiej 12 i jest jedyną w Gdańsku odtworzoną wraz ze swym wystrojem kamienicą mieszczańską. W końcu XV wieku wzniesiono w tym miejscu budynek murowany, którego relikty znajdują się w piwnicach obecnie istniejącej kamienicy. W następnych wiekach często zmieniali się właściciele posesji a dom uległ licznym przekształceniom. W roku 1775 zakupił go i przebudował Johann Uphagen, kupiec, historyk amator, bibliofil. Po śmierci właściciela kamienica pozostała w rękach rodziny i przetrwała w niemal niezmienionym stanie do początków XX wieku.");

    createPoint('Żuraw',[54.350554,18.657557],"images/zuraw.jpg", "To największy dźwig portowy średniowiecznej Europy, jedna z najbardziej charakterystycznych budowli Gdańska. Położony nad Motławą, służył do przeładunku towarów i stawiania masztów na statkach. Pełnił zarazem funkcję bramy miejskiej.");

    createPoint('Bazylika Mariacka',[54.349933,18.652116],"images/bazylikamariacka.jpg", "zwana koroną miasta Gdańska to Kościół Wniebowzięcia Najświętszej Marii Panny, największa ceglana, gotycka świątynia w Europie, powstawał 159 lat w kilku etapach w latach 1343-1502. We wnętrzu znajduje się wiele doskonałych dzieł sztuki średniowiecznej i barokowej, m.in. kamienna Pieta z ok. 1410 r., kopia Sądu Ostatecznego namalowanego przez Hansa Memlinga w roku 1472.");
