var objects = [];
   ...
   function createPoint(name, position, description, url) {
    ...
    createPoint('Złota Kamienica',[54.348621,18.6516125],"Jest jednym z najpiękniejszych budynków gdańskich. Została wzniesiona dla burmistrza Jana Speymanna, bogatego kupca i światłego mecenasa sztuk oraz jego żony Judyty z Bahrów. Powstała przed 1609 r., według projektu Abrahama van den Blocke, który był także autorem części wystroju rzeźbiarskiego, ukończonego do 1618 r.", "images/złotakamienica.jpg");
    ...
    createPoint('Żuraw',[54.3501241,18,6578039],"To największy dźwig portowy średniowiecznej Europy, jedna z najbardziej charakterystycznych budowli Gdańska. Położony nad Motławą, służył do przeładunku towarów i stawiania masztów na statkach. Pełnił zarazem funkcję bramy miejskiej.", "images/żuraw.jpg");
