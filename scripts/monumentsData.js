var objects = [];
   ...
   function createPoint(name, position, description, url) {
    ...
    createPoint('Żuraw',[54.350529,18.657557],"To największy dźwig portowy średniowiecznej Europy, jedna z najbardziej charakterystycznych budowli Gdańska. Położony nad Motławą, służył do przeładunku towarów i stawiania masztów na statkach. Pełnił zarazem funkcję bramy miejskiej.", "images/zuraw.jpg");
